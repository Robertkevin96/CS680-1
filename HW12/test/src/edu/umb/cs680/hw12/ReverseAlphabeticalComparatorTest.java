...
public class ReverseAlphabeticalComparatorTest {
	...
	// Reverse alphabetical order
		...
		public void getChilrenOfRootReverseAlphabetical() {
			...
			LinkedList<ApfsElement> children = root.getChildren(new ReverseAlphabeticalComparator());
		...
		public void getChilrenOfApplicationsReverseAlphabetical() {
			String[] expected = { "b","a" };
			LinkedList<ApfsElement> children = applications.getChildren(new ReverseAlphabeticalComparator());
			String[] actual = APFSElementToString(children);
			assertArrayEquals(expected, actual);
		}
		...
		public void getChilrenOfCodeReverseAlphabetical() {
			...
			LinkedList<ApfsElement> children = code.getChildren(new ReverseAlphabeticalComparator());
			String[] actual = APFSElementToString(children);
			assertArrayEquals(expected, actual);
		}
		...
		public void getSubDirectoriesOfHomeReverseAlphabetical() {
			...
			LinkedList<ApfsDirectory> subDirectories = home.getSubDirectories(new ReverseAlphabeticalComparator());
			String[] actual = APFSDirectoryToString(subDirectories);
			assertArrayEquals(expected, actual);
		}
		...
		public void getSubDirectoriesOfApplicationsReverseAlphabetical() {
			String[] expected = {};
			LinkedList<ApfsDirectory> subDirectories = applications.getSubDirectories(new ReverseAlphabeticalComparator());
			String[] actual = APFSDirectoryToString(subDirectories);
			assertArrayEquals(expected, actual);
		}
		...
		public void getSubDirectoriesOfCodeReverseAlphabetical() {
			String[] expected = {};
			LinkedList<ApfsDirectory> subDirectories = code.getSubDirectories(new ReverseAlphabeticalComparator());
			String[] actual = APFSDirectoryToString(subDirectories);
			assertArrayEquals(expected, actual);
		}
		@Test
		...
		public void sortFilesOfCodeReverseAlphabetical() {
			String[] expected = { "f", "e" };
			LinkedList<ApfsFile> files = code.getFiles(new ReverseAlphabeticalComparator());
			String[] actual = APFSFileToString((files));
			assertArrayEquals(expected, actual);
		}
}