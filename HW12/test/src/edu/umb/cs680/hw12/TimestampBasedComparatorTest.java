...
public class TimestampBasedComparatorTest {
	...
	// Timestamp order
		...
		public void getChilrenOfRootTimestamp() {
			...
			LinkedList<ApfsElement> children = root.getChildren(new TimestampBasedComparator());
		...
		public void getChilrenOfApplicationsTimestamp() {
			String[] expected = { "a","b" };
			LinkedList<ApfsElement> children = applications.getChildren(new TimestampBasedComparator());
			String[] actual = APFSElementToString(children);
			assertArrayEquals(expected, actual);
		}
		...
		public void getChilrenOfCodeTimestamp() {
			...
			LinkedList<ApfsElement> children = code.getChildren(new TimestampBasedComparator());
			String[] actual = APFSElementToString(children);
			assertArrayEquals(expected, actual);
		}
		...
		public void getSubDirectoriesOfRootTimestamp() {
			String[] expected = {"home", "applications" };
			LinkedList<ApfsDirectory> subDirectories = root.getSubDirectories(new TimestampBasedComparator());
		...
		public void getSubDirectoriesOfHomeTimestamp() {
			...
			LinkedList<ApfsDirectory> subDirectories = home.getSubDirectories(new TimestampBasedComparator());
			String[] actual = APFSDirectoryToString(subDirectories);
			assertArrayEquals(expected, actual);
		}
		...
		public void getSubDirectoriesOfApplicationsTimestamp() {
			String[] expected = {};
			LinkedList<ApfsDirectory> subDirectories = applications.getSubDirectories(new TimestampBasedComparator());
			String[] actual = APFSDirectoryToString(subDirectories);
			assertArrayEquals(expected, actual);
		}
		...
		public void getSubDirectoriesOfCodeTimestamp() {
			String[] expected = {};
			LinkedList<ApfsDirectory> subDirectories = code.getSubDirectories(new TimestampBasedComparator());
			String[] actual = APFSDirectoryToString(subDirectories);
			assertArrayEquals(expected, actual);
		}
		@Test
		public void sortFilesOfApplicationsTimestamp() {
			String[] expected = { "a", "b" };
			LinkedList<ApfsFile> files = applications.getFiles(new TimestampBasedComparator());
		...
		public void sortFilesOfHomeTimestamp() {
			String[] expected = { "c", "d" };
			LinkedList<ApfsFile> files = home.getFiles(new TimestampBasedComparator());
			String[] actual = APFSFileToString((files));
			assertArrayEquals(expected, actual);
		}
		@Test
		public void sortFilesOfCodeTimestamp() {
			String[] expected = { "e", "f" };
			LinkedList<ApfsFile> files = code.getFiles(new TimestampBasedComparator());
			String[] actual = APFSFileToString((files));
			assertArrayEquals(expected, actual);
		}
}