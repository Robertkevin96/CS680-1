...
public class ElementKindBasedComparatorTest {
	...
	// ElementKind order
		@Test
		public void getChilrenOfRootElementKind() {
			String[] expected = { "applications","home" };
			LinkedList<ApfsElement> children = root.getChildren(new ElementKindBasedComparator());
			String[] actual = APFSElementToString(children);
			assertArrayEquals(expected, actual);
		}

		@Test
		public void getChilrenOfApplicationsElementKind() {
			String[] expected = { "a","b" };
			LinkedList<ApfsElement> children = applications.getChildren(new ElementKindBasedComparator());
			String[] actual = APFSElementToString(children);
			assertArrayEquals(expected, actual);
		}

		@Test
		public void getChilrenOfHomeElementKind() {
		...
		@Test
		public void getChilrenOfCodeElementKind() {
			String[] expected = { "e","f","y" };
			LinkedList<ApfsElement> children = code.getChildren(new ElementKindBasedComparator());
			String[] actual = APFSElementToString(children);
			assertArrayEquals(expected, actual);
		}

		@Test
		public void getSubDirectoriesOfRootElementKind() {
			String[] expected = {"applications", "home" };
			LinkedList<ApfsDirectory> subDirectories = root.getSubDirectories(new ElementKindBasedComparator());
			String[] actual = APFSDirectoryToString(subDirectories);
			assertArrayEquals(expected, actual);
		}

		@Test
		public void getSubDirectoriesOfHomeElementKind() {
			String[] expected = { "code" };
			LinkedList<ApfsDirectory> subDirectories = home.getSubDirectories(new ElementKindBasedComparator());
			String[] actual = APFSDirectoryToString(subDirectories);
			assertArrayEquals(expected, actual);
		}

		@Test
		public void getSubDirectoriesOfApplicationsElementKind() {
			String[] expected = {};
			LinkedList<ApfsDirectory> subDirectories = applications.getSubDirectories(new ElementKindBasedComparator());
			String[] actual = APFSDirectoryToString(subDirectories);
			assertArrayEquals(expected, actual);
		}

		@Test
		public void getSubDirectoriesOfCodeElementKind() {
			String[] expected = {};
			LinkedList<ApfsDirectory> subDirectories = code.getSubDirectories(new ElementKindBasedComparator());
			String[] actual = APFSDirectoryToString(subDirectories);
			assertArrayEquals(expected, actual);
		}
		@Test
		public void sortFilesOfApplicationsElementKind() {
			String[] expected = { "a", "b" };
			LinkedList<ApfsFile> files = applications.getFiles(new ElementKindBasedComparator());
			String[] actual = APFSFileToString((files));
			assertArrayEquals(expected, actual);
		}
		@Test
		public void sortFilesOfHomeElementKind() {
			String[] expected = { "c", "d" };
			LinkedList<ApfsFile> files = home.getFiles(new ElementKindBasedComparator());
			String[] actual = APFSFileToString((files));
			assertArrayEquals(expected, actual);
		}
		@Test
		public void sortFilesOfCodeElementKind() {
			String[] expected = { "e", "f" };
			LinkedList<ApfsFile> files = code.getFiles(new ElementKindBasedComparator());
			String[] actual = APFSFileToString((files));
			assertArrayEquals(expected, actual);
		}
}